...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "sPd0AShY#S18zlRHSPV1hg9cjp87CcpysgGudFJ5TP2Mk1OPnlyM",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "DIMU BOT",
  author: process.env.author || "DIMU BOT",
  //==========================================- API-CONFIGS -==========================================================
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ D I M U*` ,
  ...
  ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/hdZGTdf/IMG-8655.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://i.ibb.co/hdZGTdf/IMG-8655.jpg",
